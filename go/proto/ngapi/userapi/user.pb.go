...
func (*UnimplementedUserServer) TempCapture(ctx context.Context, req *TempCaptureRequest) (*TempCaptureResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TempCapture not implemented")
}
func (*UnimplementedUserServer) Datasets(req *DatasetsRequest, srv User_DatasetsServer) error {
